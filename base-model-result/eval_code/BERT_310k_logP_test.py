...
if __name__ == '__main__':
    ...
    dev_text = pd.read_csv('/root/data/UN_data/250k_logP/250k_logP_dev.csv')['smiles'].values.tolist()
    dev_label = pd.read_csv('/root/data/UN_data/250k_logP/250k_logP_dev.csv')['logP'].values.tolist()
    test_text = pd.read_csv('/root/data/UN_data/250k_logP/250k_logP_test.csv')['smiles'].values.tolist()
    test_label = pd.read_csv('/root/data/UN_data/250k_logP/250k_logP_test.csv')['logP'].values.tolist()
    train_batch_size = 16
    mse_loss = nn.MSELoss()
    lr = 0.00001
    ...
    best_model = torch.load('/root/bert_250k_logP_best_model.pt')
    ...
    pre_list_pd.to_csv('333.csv',index=False)