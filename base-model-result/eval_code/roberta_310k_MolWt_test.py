...
if __name__ == '__main__':
    ...
    bertModel = BertModel.from_pretrained('/home/ubuntu/roberta-small')
    ...
    best_loss = 0.5
    best_model = torch.load('/home/ubuntu/ais_roberta/roberta_310k_MolWt_best_model.pt')
    ...
    pre_list_pd.to_csv('RoBERTa_310k_MolWt_pre.csv',index=False)