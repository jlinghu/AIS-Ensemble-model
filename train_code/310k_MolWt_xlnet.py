...
class asmilesModel(nn.Module):
    ...
    def forward(self,batch_text,batch_label,batch_attention_mask):
        ...
        bert_out0 = self.sigmoid(bert_out0[0])
...
if __name__ == '__main__':
    ...
    for e in range(epoch):
        ...
        if e > 80 and loss_ < best_loss:
                best_loss = loss_
                torch.save(model, "xlnet_310k_MolWt_best_model.pt")

    best_model = torch.load('xlnet_310k_MolWt_best_model.pt')
    ...
    result_data.to_csv('xlnet_310k_MolWt_result_data.csv',index=False)