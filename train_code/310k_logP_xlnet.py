...
if __name__ == '__main__':
    ...
    for e in range(epoch):
        ...
        if e > 80 and loss_ < best_loss:
                best_loss = loss_
                torch.save(model, "xlnet_310k_logP_best_model(nosuoxiao).pt")

    best_model = torch.load('xlnet_310k_logP_best_model(nosuoxiao).pt')
    ...
    result_data.to_csv('xlnet_310k_logP_result_data.csv',index=False)