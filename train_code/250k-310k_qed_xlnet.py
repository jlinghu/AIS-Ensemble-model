...
if __name__ == '__main__':
    ...
    for e in range(epoch):
        ...
        if e > 90 and loss_ < best_loss:
                best_loss = loss_
                torch.save(model, "xlnet_250k_qed_best_model.pt")
          

    best_model = torch.load('xlnet_250k_qed_best_model.pt')
    ...
    result_data.to_csv('xlnet_250k_qed_result_data.csv',index=False)