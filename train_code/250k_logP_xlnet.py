...
if __name__ == '__main__':
    ...
    bertModel = XLNetModel.from_pretrained('/root/xlnet')
    setup_seed(42)
    ...
    for e in range(epoch):
        ...
        loss_ = avg_loss
        if e > 80 and loss_ < best_loss:
                best_loss = loss_
                torch.save(model, "xlnet_250k_logP_best_model.pt")

    best_model = torch.load('xlnet_250k_logP_best_model.pt')
    ...
    result_data.to_csv('xlnet_250k_logP_result_data.csv',index=False)