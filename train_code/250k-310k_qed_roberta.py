...
if __name__ == '__main__':
    ...
    bertModel = AutoModel.from_pretrained('/root/roberta')
    ...
    for e in range(epoch):
        ...
        if e > 90 and loss_ < best_loss:
                best_loss = loss_
                torch.save(model, "roberta-250k_qed_best_model.pt")
          

    best_model = torch.load('roberta-250k_qed_best_model.pt')
    ...
    result_data.to_csv('roberta_250k_qed_result_data.csv',index=False)