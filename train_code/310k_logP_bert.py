...
if __name__ == '__main__':
    ...
    for e in range(epoch):
        ...
        if e > 80 and loss_ < best_loss:
            best_loss = loss_
            torch.save(model, "bert_310k_logP_best_model(nosuoxiao).pt")

    best_model = torch.load('bert_310k_logP_best_model(nosuoxiao).pt')
    ...
    result_data.to_csv('bert_310k_logP_result_data(nosuoxiao).csv', index=False)